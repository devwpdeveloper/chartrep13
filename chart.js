...
// left yaxis text
            ...
            const bottomtextp = document.createTextNode("WEEK TIME DURATION");
            ...
            function mousemove() {
                ...
                var x0 = chartObj.xScale.invert(d3.mouse(this)[0]), i = chartObj.bisectYear(dataset, x0, 1),     
                  ...
                  let yearVaue = chartObj.data[i].year;

                  if(yearVaue !== lastYearValue)
                  {
                      lastYearValue = yearVaue;
                      i = i-1;
                       document.getElementsByClassName("week")[0].innerHTML = "Week " + chartObj.data[i].year;
                    //   document.getElementById("DoNothing").innerHTML = "(" + chartObj.data[i].variableA + ")";
                    //   document.getElementById("Control").innerHTML = "(" +chartObj.data[i].variableB + ")";
                    //   document.getElementById("Phentermine").innerHTML = "(" +chartObj.data[i].variableC + ")";
                    //   document.getElementById("Qsymia").innerHTML = "(" +chartObj.data[i].variableD + ")";
                    //   document.getElementById("Wegovy").innerHTML = "(" +chartObj.data[i].variableE + ")";
                    //   document.getElementById("Mounjaro").innerHTML = "(" +chartObj.data[i].variableF + ")"; 
                  }

                  i = i+1;                

                  let xaixs = d3.mouse(this)[0];
                xaixs += 100;
                document.getElementsByClassName("custom-card")[0].style.left = xaixs + 'px';
